...
class Smilies_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        ...
        Typecho_Plugin::factory('Widget_Abstract_Comments')->excerptEx = array('Smilies_Plugin', 'convertSmilies');
    }
    ...
    {
        require_once 'Smilies/Smilies.php';
    }
    ...
    public static function convertSmilies($text)
    {
      ...
      $allow_img = Typecho_Widget::widget('Widget_Options')->plugin('Smilies')->allowPostImg;
      if ( $allow_img == 1 )
