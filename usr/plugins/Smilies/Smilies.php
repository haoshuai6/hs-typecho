...
<?php
if ($allow_post_img) {
    echo '<span class="embedImage" style="margin-left:8px;"><a href="javascript:Smilies.embedImage();">贴图</a></span>';
}
?>
<span class="embedSmiley" style="margin-left:8px;"><a href="javascript:Smilies.showBox();">表情</a></span>

<script type="text/javascript">
// <![CDATA[
// Smilies v1.0.3 for Typecho Comments - by willin kan - URI: http://kan.willin.org/typecho/
Smilies = {
 dom : function(id) {
